...
var YoBitAdapter = require('./adapters/YoBitAdapter'),
    PoloniexAdapter = require('./adapters/PoloniexAdapter'),
    BittrexAdapter = require('./adapters/BittrexAdapter'),
    ForexPFAdapter = require('./adapters/ForexPFAdapter'),
    VirtualAdapter = require('./adapters/VirtualAdapter'),
    LivecoinAdapter = require('./adapters/LivecoinAdapter')
    LiquiAdapter = require('./adapters/LiquiAdapter')
    ;
/**
...
function try_proxy(from,to,proxy,callback) {
    ...
    Promise.all(promises).then(function() {
        // console.log('Price of %s in %s is %s', from,proxy,tgt['from']);
        // console.log('Price of %s in %s is %s', to,proxy,tgt['to']);
        return callback(tgt['to'] / tgt['from']);
...
//add_adapter(LivecoinAdapter);
//add_adapter(LiquiAdapter);
add_adapter(YoBitAdapter);
add_adapter(BittrexAdapter);
add_adapter(ForexPFAdapter);
add_adapter(VirtualAdapter);
